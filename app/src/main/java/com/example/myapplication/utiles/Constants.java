...
public class Constants {
    ...
    public static List<GoldStatus> goldStatuses = new ArrayList<>();

    static {
//        {"Android", "iOS", "前端", "后端", "设计", "产品", "阅读", "工具资源"};
        goldStatuses.add(new GoldStatus(true,0,"Android"));
        goldStatuses.add(new GoldStatus(true,1,"iOS"));
        goldStatuses.add(new GoldStatus(true,2,"前端"));
        goldStatuses.add(new GoldStatus(true,3,"后端"));
        goldStatuses.add(new GoldStatus(false,4,"设计"));
        goldStatuses.add(new GoldStatus(false,5,"产品"));
        goldStatuses.add(new GoldStatus(false,6,"阅读"));
        goldStatuses.add(new GoldStatus(false,7,"工具资源"));
    }
